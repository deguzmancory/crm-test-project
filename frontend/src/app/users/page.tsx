...
export default function UsersPage() {
    ...
    return (
        <div className="p-6">
            ...
            {!loading && !error && (
                <div>
                    ...
                    <ul className="list-disc pl-6">
                        {users.map((user) => (
                            <li key={user.id ?? Date.now()} className="text-lg flex justify-between items-center">
                                <span>
            ...
            <UserModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} onCreateUser={handleCreateUser} />
        </div>
    );
}
